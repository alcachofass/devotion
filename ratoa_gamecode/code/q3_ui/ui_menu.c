...
static void Main_MenuDraw( void ) {
	...
	else
	{
        ...
        //Draw version.
		//color[0] = 0;
                UI_DrawString( 320, 480-14, COMPILE_VERSION, UI_CENTER|UI_DROPSHADOW|UI_SMALLFONT, color_red );
...
//	Menu_AddItem( &s_main.menu,	&s_main.introduction );
	...
	trap_S_StartBackgroundTrack("sound/misc/Aries_Beats_-_Sad_Synthwave.wav", NULL);
