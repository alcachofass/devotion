...
iteminfo "item_coingold"
{
name		"Gold Coin"
model		"models/rat/ratcoin.md3"
modelindex	MODELINDEX_COINGOLD
type		COINI
index		INVENTORY_COIN
mins		{-13,-13,-13}
maxs		{13,13,13}
} 
iteminfo "item_coinsilver"
{
name		"Silver Coin"
model		"models/rat/ratcoin.md3"
modelindex	MODELINDEX_COINSILVER
type		COINI
index		INVENTORY_COIN
mins		{-13,-13,-13}
maxs		{13,13,13}
} 
iteminfo "item_coinbronze"
{
name		"Bronze Coin"
model		"models/rat/ratcoin.md3"
modelindex	MODELINDEX_COINBRONZE
type		COINI
index		INVENTORY_COIN
mins		{-13,-13,-13}
maxs		{13,13,13}
...
name		"Blue Coin"
model		"models/rat/ratcoin.md3"
modelindex	MODELINDEX_COINBLUE
type		COINI
index		INVENTORY_COIN
mins		{-13,-13,-13}
maxs		{13,13,13}
