...
CG_CVAR( cg_debugBotAim, "cg_debugBotAim", "0", CVAR_CHEAT )
...
CG_CVAR( cg_redTeamName, "g_redteam", DEFAULT_REDTEAM_NAME, CVAR_ARCHIVE )
CG_CVAR( cg_blueTeamName, "g_blueteam", DEFAULT_BLUETEAM_NAME, CVAR_ARCHIVE )
...
CG_CVAR( cg_hudMode, "cg_hudMode", "0", CVAR_ARCHIVE )
CG_CVAR( ch_file, "ch_file", "devotion_default", CVAR_ARCHIVE )
...
CG_CVAR( cg_predictHitSound, "cg_predictHitSound", "1", CVAR_ARCHIVE )
