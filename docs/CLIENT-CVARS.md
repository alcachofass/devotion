...
| `cg_debugBotAim` | Devotion | `0` | 0–7 | Draw bot harness aim debug: `1` = followed bot intent line, `2` = all bots, `4` = add viewangles ray. Needs `bot_debugAim 1` on server. `CVAR_CHEAT`. |
