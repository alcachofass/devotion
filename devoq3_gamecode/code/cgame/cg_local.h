...
//#define	STEP_TIME			200	//mrd
#define	STEP_TIME			110	//mrd - less of a stair sag effect
...
// Master server for ratmod and devotion
...
void CG_DemoEvents_DrawPresence( int trackX, int trackY, int trackW, int trackH, int firstServerTime, int durationMs, int clientNum );
